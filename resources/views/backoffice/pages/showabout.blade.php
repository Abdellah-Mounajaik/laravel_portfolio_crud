...
@section('back')
<div class="container">
    <h1 class="mt-5 text-center">Plus de détails sur le profils</h1>
    <main id="main">
          ...
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <ul>
                      ...
                      <li><i class="icofont-rounded-right"></i> <strong>PhEmailone:</strong> {{$about->PhEmailone}}</li>
                ...
                <button class="btn btn-primary"><a class="text-white" href="{{route('back.about')}}">Revenir à la page arrière</a>
